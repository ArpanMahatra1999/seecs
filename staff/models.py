...
class Staff(models.Model):
    ...
    photo = models.ImageField(null=True, blank=True, upload_to='images/staff/',
                              default='images/staff/default_staff.png')
    ...
    # address
    permanent_province = models.ForeignKey(Province, on_delete=models.CASCADE, related_name="staff_permanent_province")
    permanent_district = models.ForeignKey(District, on_delete=models.CASCADE, related_name="staff_permanent_district")
    permanent_municipality = models.ForeignKey(Municipality, on_delete=models.CASCADE, related_name="staff_permanent_municipality")
    ...
    temporary_province = models.ForeignKey(Province, on_delete=models.CASCADE, related_name="staff_temporary_province")
    temporary_district = models.ForeignKey(District, on_delete=models.CASCADE, related_name="staff_temporary_district")
    temporary_municipality = models.ForeignKey(Municipality, on_delete=models.CASCADE, related_name="staff_temporary_municipality")
    ...
    citizenship_issued_district = models.ForeignKey(District, on_delete=models.CASCADE, related_name="staff_citizenship_issued_district")
