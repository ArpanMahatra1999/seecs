    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, default='images/trainee/default_trainee.png', null=True, upload_to='images/trainee/')),
                ...
                ('has_taken_similar_training_before', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=255)),
                ('training_status', models.CharField(choices=[('Completed', 'Completed'), ('Incompleted', 'Incompleted')], max_length=255)),
                ('certification_type', models.CharField(choices=[('NSTB Registration', 'NSTB Registration'), ('Foreign Certificate', 'Foreign Certificated')], max_length=255)),
                ('registration_number', models.CharField(max_length=255)),
                ('citizenship_issued_district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trainee_citizenship_issued_district', to='location.district')),
                ...
                ('permanent_district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trainee_permanent_district', to='location.district')),
                ('permanent_municipality', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trainee_permanent_municipality', to='location.municipality')),
                ('permanent_province', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trainee_permanent_province', to='location.province')),
                ('temporary_district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trainee_temporary_district', to='location.district')),
                ('temporary_municipality', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trainee_temporary_municipality', to='location.municipality')),
                ('temporary_province', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trainee_temporary_province', to='location.province')),
            ],
        ),
    ]
