    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, default='images/smt_system/default_smt_system.png', null=True, upload_to='images/smt_system/')),
                ...
                ('citizenship_issued_district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='smtm_citizenship_issued_district', to='location.district')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('dss', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dss.dss')),
                ('permanent_district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='smtm_permanent_district', to='location.district')),
                ('permanent_municipality', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='smtm_permanent_municipality', to='location.municipality')),
                ('permanent_province', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='smtm_permanent_province', to='location.province')),
                ('temporary_district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='smtm_temporary_district', to='location.district')),
                ('temporary_municipality', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='smtm_temporary_municipality', to='location.municipality')),
                ('temporary_province', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='smtm_temporary_province', to='location.province')),
            ],
        ),
    ]
