...
class SMTMember(models.Model):
    ...
    # identity
    photo = models.ImageField(null=True, blank=True, upload_to='images/smt_system/',
                              default='images/smt_system/default_smt_system.png')
    ...
    # address
    permanent_province = models.ForeignKey(Province, on_delete=models.CASCADE, related_name="smtm_permanent_province")
    permanent_district = models.ForeignKey(District, on_delete=models.CASCADE, related_name="smtm_permanent_district")
    permanent_municipality = models.ForeignKey(Municipality, on_delete=models.CASCADE, related_name="smtm_permanent_municipality")
    ...
    temporary_province = models.ForeignKey(Province, on_delete=models.CASCADE, related_name="smtm_temporary_province")
    temporary_district = models.ForeignKey(District, on_delete=models.CASCADE, related_name="smtm_temporary_district")
    temporary_municipality = models.ForeignKey(Municipality, on_delete=models.CASCADE, related_name="smtm_temporary_municipality")
    ...
    # membership records
    smc_member = models.BooleanField(default=False, verbose_name='SMC Member')
    eicc_member = models.BooleanField(default=False, verbose_name='EICC Member')

    # citizenship records
    citizenship_number = models.CharField(max_length=255)
    citizenship_issued_district = models.ForeignKey(District, on_delete=models.CASCADE, related_name="smtm_citizenship_issued_district")
